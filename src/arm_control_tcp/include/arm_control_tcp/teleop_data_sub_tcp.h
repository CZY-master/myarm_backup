#ifndef __TELEOP_DATA_SUB_TCP_H_
#define __TELEOP_DATA_SUB_TCP_H_
...
extern std::vector<std::vector<double>> record_joint_angles; // 存储关节角度 
extern std::vector<double> record_timestamps;             // 存储时间戳
extern ros::Time start_time;                                 // 保存第一个时间戳
