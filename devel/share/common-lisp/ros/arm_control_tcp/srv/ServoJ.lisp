...
(cl:defmethod cl:initialize-instance :after ((m <ServoJ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoJ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_control_tcp-srv:<ServoJ-request> is deprecated: use arm_control_tcp-srv:ServoJ-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ServoJ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoJ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_control_tcp-srv:<ServoJ-response> is deprecated: use arm_control_tcp-srv:ServoJ-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServoJ-response>)))
  ...
  "arm_control_tcp/ServoJResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServoJ-response)))
  "Returns string type for a service object of type 'ServoJ-response"
  "arm_control_tcp/ServoJResponse")
