...
(cl:in-package arm_control_tcp-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <MovJ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MovJ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_control_tcp-srv:<MovJ-request> is deprecated: use arm_control_tcp-srv:MovJ-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <MovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:mode-val is deprecated.  Use arm_control_tcp-srv:mode instead.")
  (mode m))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <MovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:a-val is deprecated.  Use arm_control_tcp-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <MovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:b-val is deprecated.  Use arm_control_tcp-srv:b instead.")
  (b m))

(cl:ensure-generic-function 'c-val :lambda-list '(m))
(cl:defmethod c-val ((m <MovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:c-val is deprecated.  Use arm_control_tcp-srv:c instead.")
  (c m))

(cl:ensure-generic-function 'd-val :lambda-list '(m))
(cl:defmethod d-val ((m <MovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:d-val is deprecated.  Use arm_control_tcp-srv:d instead.")
  (d m))

(cl:ensure-generic-function 'e-val :lambda-list '(m))
(cl:defmethod e-val ((m <MovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:e-val is deprecated.  Use arm_control_tcp-srv:e instead.")
  (e m))

(cl:ensure-generic-function 'f-val :lambda-list '(m))
(cl:defmethod f-val ((m <MovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:f-val is deprecated.  Use arm_control_tcp-srv:f instead.")
  (f m))

(cl:ensure-generic-function 'paramValue-val :lambda-list '(m))
(cl:defmethod paramValue-val ((m <MovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:paramValue-val is deprecated.  Use arm_control_tcp-srv:paramValue instead.")
  (paramValue m))
...
(cl:defmethod cl:initialize-instance :after ((m <MovJ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MovJ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_control_tcp-srv:<MovJ-response> is deprecated: use arm_control_tcp-srv:MovJ-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <MovJ-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control_tcp-srv:res-val is deprecated.  Use arm_control_tcp-srv:res instead.")
  (res m))
